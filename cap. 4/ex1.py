...
#exemplo de uma classe Content (que representa o conteúdo de um site, por exemplo, um artigo de notícia) e duas funções de coleta de dados que aceitam um objeto BeautifulSoup e devolvem uma instância de Content:
